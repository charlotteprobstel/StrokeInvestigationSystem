...
public class StrokeInvestigationSystem {
    public static void main(String[] args) {
        ...
        BPMeasurement daphneBP = new BPMeasurement(130, 70, LocalDate.of(2023,9,15), BPTerm.ST);
        ...
        BPMeasurement sebastianBP = new BPMeasurement(150, 80, LocalDate.of(2023,11,20),BPTerm.VST);
        ...
        BPMeasurement daphneBP2 = new BPMeasurement(90, 70, LocalDate.of(2023,5,11),BPTerm.VST);
